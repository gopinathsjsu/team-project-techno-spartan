  ...
  return (
    <div className="side-navigation h-100">
      <Nav defaultActiveKey="/dashboard" className="flex-column pt-3">
          ...
          {!props.admin && <Nav.Link href="/profile" eventKey="profile" className="row mx-0"><ProfileIcon className="sidebar-icon col-5 px-1"/><h4 className="sidebar-title col-auto">Profile</h4></Nav.Link>}
